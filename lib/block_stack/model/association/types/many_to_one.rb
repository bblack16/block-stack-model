  ...
  module Associations
    class ManyToOne < OneToOne
      ...
      def associate(obj_a, obj_b)
        ...
        raise InvalidAssociationError, "#{obj_a.class} does not have a method named #{attribute} and cannot be associated with a #{obj_b.class}." unless obj_a.respond_to?(attribute)
